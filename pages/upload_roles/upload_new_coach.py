...
class UploadNewCoachPage(BasePage): 
    ...
    def create_upload_new_coach(self):
        ...
        org_admin_option = self.page.locator('.ng-option', has_text='Coach') 
        org_admin_option.click() 
        print("Selected Coach role")
        # Path to the Excel file in the data folder 
        excel_filename = 'data/Coach_Register_Template.xlsx'
