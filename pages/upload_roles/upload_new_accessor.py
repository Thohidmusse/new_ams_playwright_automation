...
class UploadNewAssessorPage(BasePage): 
    ...
    def create_upload_new_Assessor(self):
        ...
        org_admin_option = self.page.locator('.ng-option', has_text='Assessor') 
        org_admin_option.click() 
        print("Selected Science staff role")
        # Path to the Excel file in the data folder 
        excel_filename = 'data/Assessor_Template.xlsx'
