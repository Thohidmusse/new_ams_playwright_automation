...
class UploadNewScienceStaffPage(BasePage): 
    ...
    def create_upload_new_science_staff(self):
        ...
        org_admin_option = self.page.locator('.ng-option', has_text='Science Staff') 
        org_admin_option.click() 
        print("Selected Science staff role")
        # Path to the Excel file in the data folder 
        excel_filename = 'data/Science_Staff_Register_Template.xlsx'
