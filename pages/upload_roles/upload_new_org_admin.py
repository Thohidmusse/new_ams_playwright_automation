...
class UploadNewOrgAdminPage(BasePage): 
    ...
    def create_upload_new_org_admin(self):
        ...
        org_admin_option = self.page.locator('.ng-option', has_text='Org Admin') 
        org_admin_option.click() 
        print("Selected Org Admin role")
        # Path to the Excel file in the data folder 
        excel_filename = 'data/OrgAdmin_Template.xlsx'
