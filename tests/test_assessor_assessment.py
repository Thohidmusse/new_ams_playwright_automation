import pytest
from pages.new_assessor_assessment_page import AssessorAssessmentPage
...
def test_new_assessment(logged_in_page):
     newassesment_page = AssessorAssessmentPage(logged_in_page) 
     newassesment_page.perform_assessment()
